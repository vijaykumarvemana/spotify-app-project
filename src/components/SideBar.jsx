...
const SideBar = () => {
    return(
        ...
        <div className="vertical-nav" id="sidebar">
          <a className="navbar-brand mt-3" href="main.html"
            ><img
          ...
          <ul className="nav flex-column mb-0">
            <div className="mx-1 mb-1 active-link">
              <li className="nav-item px-4">
                <button>
                  <i className="bi bi-house-door-fill active-link d-inline-block"></i>
                  <a href="main.html" clasNames="nav-link active-link d-inline-block"
                    >Home
                  </a>
                </button>
              </li>
            ...
            <div className="mx-1 mb-1">
              <li className="nav-item px-4">
                <button>
                  <i className="bi bi-search d-inline-block"></i>
                  <a href="#" className="nav-link d-inline-block"> Search </a>
                </button>
              </li>
            </div>
            <div className="mx-1 mb-1">
              <li className="nav-item px-4">
                <button>
                  <i className="bi bi-collection d-inline-block"></i>
                  <a href="#" className="nav-link d-inline-block"> Your Library </a>
                </button>
              </li>
            </div>
          </ul>
          <ul className="nav flex-column mt-3">
            <div className="mx-1 mb-1">
              <li className="nav-item px-4">
                <button onclick="playlistCreator()">
                  <i className="bi bi-plus-square d-inline-block"></i>
                  <a href="#" className="nav-link d-inline-block">Create playlist</a>
                </button>
              </li>
            </div>
            <div className="mx-1 mb-0">
              <li className="nav-item px-4">
                <i className="bi bi-heart-fill d-inline-block"></i>
                <a href="favourites.html" clasNames="nav-link d-inline-block">
                  Liked Songs
                </a>
              </li>
            </div>
          ...
          <ul className="nav flex-column mt-3">
            <div id="playlist-holder" clasNames="mx-1 mb-1"></div>
          </ul>
          <ul className="nav flex-column mt-3">
            <div className="mx-1 mb-0">
              <li className="nav-item px-4">
                <button>
                  <i
                    className="far fa-arrow-alt-circle-down d-inline-block"
                    style="vertical-align: middle"
                  ></i>
                  <a href="#" className="nav-link d-inline-block"> Install App </a>
                </button>
              </li>
            </div>
          </ul>
